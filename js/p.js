...
const baseColorTexture = textureLoader.load('/js/texture/A_b.jpg');
const heightMapTexture = textureLoader.load('/js/texture/A_h.png');
const normalMapTexture = textureLoader.load('/js/texture/A_n.jpg');
const aoTexture = textureLoader.load('/js/texture/A_ao.jpg');
// const RoughMapTexture = textureLoader.load('/js/texture/C_r.jpg');
const specMap = textureLoader.load('/js/texture/A_s.jpg')
...
const geometry = new THREE.TorusKnotBufferGeometry(15,1.3, 1250, 60,6, 10);
const k = 1;
const l = 1;
