...
const specMap = textureLoader.load('/js/texture/F_s.jpg');
const displacementMapTexture = textureLoader.load('/js/texture/F_d.png')
...
const geometry = new THREE.TorusKnotBufferGeometry(14, 2, 256, 50,1, 3);
...
const whiteMat = new THREE.MeshBasicMaterial({color: 0xff4a14});
...
function animate() {
	...
	cube.rotation.x += mouse.y/2000;
	cube.rotation.y -= mouse.x/2000;
